...
<style>
    ...
    /* Sidebar */
    .sidebar { padding-top: 60px; position: fixed; top: 0; right: -360px; width: 340px; height: 100%; background: var(--bg-surface); border-left: 2px solid var(--color-solution); z-index: 200; transition: right 0.3s; display: flex; flex-direction: column; box-shadow: -5px 0 15px rgba(0,0,0,0.5); }
